...
if age >= 18:
    ...
    if wants_to_play == "yes":
        ...
        if left_or_right == "left":
            answer = input("Nice, you follow the path and reach a lake... Do you swim across or go around (across/around)? ")

            if answer == "around":
                print("You went around and reached the other side the lake.")
            elif answer == "across":
